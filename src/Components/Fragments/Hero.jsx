...
const Hero = () => {
  return (
    <div className=" text-white flex flex-col lg:flex-row md:flex-row justify-center items-center lg:mx-10 my-6">
      ...
      <img src="/hero.png" alt="A happy dog" className="lg:w-[31%] md:w-[44%] w-[54%]" />
    </div>
  );
};
